 ...
 * @returns {string} 获取当前页面栈的实例
 * @link 获取当前页面栈的实例 https://uniapp.dcloud.io/api/window/window.html#getcurrentpages
 */
function showNavBar() {
  const page = getCurrentPages()[getCurrentPages().length - 1];
  return page.$page.meta?.navigationBar?.style !== "custom";
}
/**
 * @description 运行期判断平台
