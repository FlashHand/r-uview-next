<template>
  <view class="u-input" :class="inputClass" :style="[wrapperStyle]">
    <view class="u-input__content">
      <view class="u-input__content__prefix-icon" v-if="prefixIcon">
        <u-icon
          :name="prefixIcon"
          size="18"
      ...
      <view class="u-input__content__prefix-icon" v-else>
        <slot name="prefix" />
      </view>
      <view class="u-input__content__field-wrapper" @tap="clickHandler">
        <!-- 根据uni-app的input组件文档，H5和APP中只要声明了password参数(无论true还是false)，type均失效，此时
				 ...
				 -->
        <input
          class="u-input__content__field-wrapper__field u-line-1"
          :style="[inputStyle]"
          :type="type"
          :focus="focus"
          :cursor="cursor"
      ...
      <view class="u-input__content__subfix-icon" v-if="suffixIcon">
        <u-icon
          :name="suffixIcon"
          size="18"
      ...
      <view class="u-input__content__subfix-icon" v-else>
        <slot name="suffix" />
      </view>
    </view>
  </view>
 ...
 * @example [vue3] <u-input v-model:value="value" :password="true" suffix-icon="lock-fill" />
 */
export default {
  name: "u-input",
