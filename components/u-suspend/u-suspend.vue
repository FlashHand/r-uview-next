<template>
  <view class="u-tooltip" :style="[$u.addStyle(customStyle)]">
    ...
    ></u-overlay>
    <view class="u-tooltip__wrapper u-w-full">
      <view class="u-w-full" :id="textId" :ref="textId">
        <slot />
      </view>
      <u-transition
        v-if="showTooltip"
      ...
      >
        ...
        >
          <view
            class="u-tooltip__wrapper__popup__indicator-copy"
            :style="[
              {
 ...
 * suspend
 * @description
 * @tutorial https://www.uviewui.com/components/xxx.html
    ...
    tooltipStyle() {
      const style = {
          transform: `translateY(${
            this.direction === "top" ? "-100%" : `${this.textInfo.height + 6}px`
          })`,
        },
        sys = uni.$u.sys(),
        getPx = uni.$u.getPx,
